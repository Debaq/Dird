...
### 4.7 `classifications.json` (per session)

The per-image diabetic-retinopathy classification — **the clinical conclusion** (severity,
applied guideline, treatments, urgency, and the audit flag `manuallyModified`). Present when
the image was classified. Omitting this file loses the diagnosis on re-import.
  ...
  "classifications": [
    {
      ...
      "severity": "string (guideline-specific grade)",
      "confidence": "low | moderate | high",
      "guideline": "icdr-2024 | minsal-2017 | ...",
      "treatments": "string",
      "followupDays": 180,
...
| `classifications.json` | `imageClassifications` | Foreign key: `imageId` — the DR diagnosis |
